...
export class DefaultApi extends runtime.BaseAPI {
    ...
    /**
     */
    async authControllerDoEmailSignInRaw(requestParameters: AuthControllerDoEmailSignInRequest): Promise<runtime.ApiResponse<AuthedSessionDto>> {
        if (requestParameters.emailAuthRequestDto === null || requestParameters.emailAuthRequestDto === undefined) {
            throw new runtime.RequiredError('emailAuthRequestDto','Required parameter requestParameters.emailAuthRequestDto was null or undefined when calling authControllerDoEmailSignIn.');
        }
    ...
    /**
     */
    async authControllerDoEmailSignUpRaw(requestParameters: AuthControllerDoEmailSignUpRequest): Promise<runtime.ApiResponse<AuthedSessionDto>> {
        if (requestParameters.emailAuthRequestDto === null || requestParameters.emailAuthRequestDto === undefined) {
            throw new runtime.RequiredError('emailAuthRequestDto','Required parameter requestParameters.emailAuthRequestDto was null or undefined when calling authControllerDoEmailSignUp.');
        }
    ...
    /**
     */
    async authControllerDoGoogleOAuthRaw(requestParameters: AuthControllerDoGoogleOAuthRequest): Promise<runtime.ApiResponse<AuthedSessionDto>> {
        if (requestParameters.oAuthGoogleRequestDto === null || requestParameters.oAuthGoogleRequestDto === undefined) {
            throw new runtime.RequiredError('oAuthGoogleRequestDto','Required parameter requestParameters.oAuthGoogleRequestDto was null or undefined when calling authControllerDoGoogleOAuth.');
        }
    ...
    /**
     */
    async momoUserControllerGetCollectionsRaw(requestParameters: MomoUserControllerGetCollectionsRequest): Promise<runtime.ApiResponse<UserCollectionListDto>> {
        if (requestParameters.userId === null || requestParameters.userId === undefined) {
            throw new runtime.RequiredError('userId','Required parameter requestParameters.userId was null or undefined when calling momoUserControllerGetCollections.');
        }
        ...
        const response = await this.request({
            path: `/momo/user/{userId}/collections`.replace(`{${"userId"}}`, encodeURIComponent(String(requestParameters.userId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
    ...
    /**
     */
    async momoUserControllerGetCollections(requestParameters: MomoUserControllerGetCollectionsRequest): Promise<UserCollectionListDto> {
    ...
    /**
     */
    async momoUserControllerListFriendCollectionsRaw(requestParameters: MomoUserControllerListFriendCollectionsRequest): Promise<runtime.ApiResponse<FriendCollectionsDto>> {
        if (requestParameters.userId === null || requestParameters.userId === undefined) {
            throw new runtime.RequiredError('userId','Required parameter requestParameters.userId was null or undefined when calling momoUserControllerListFriendCollections.');
        }
        ...
        const response = await this.request({
            path: `/momo/user/{userId}/friendCollections`.replace(`{${"userId"}}`, encodeURIComponent(String(requestParameters.userId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
    ...
    /**
     */
    async momoUserControllerListFriendCollections(requestParameters: MomoUserControllerListFriendCollectionsRequest): Promise<FriendCollectionsDto> {
    ...
    /**
     */
    async momoUserControllerListFriendsRaw(requestParameters: MomoUserControllerListFriendsRequest): Promise<runtime.ApiResponse<FriendListDto>> {
        if (requestParameters.userId === null || requestParameters.userId === undefined) {
            throw new runtime.RequiredError('userId','Required parameter requestParameters.userId was null or undefined when calling momoUserControllerListFriends.');
        }
        ...
        const response = await this.request({
            path: `/momo/user/{userId}/friends`.replace(`{${"userId"}}`, encodeURIComponent(String(requestParameters.userId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
    ...
    /**
     */
    async momoUserControllerPutCollectionsRaw(requestParameters: MomoUserControllerPutCollectionsRequest): Promise<runtime.ApiResponse<UserCollectionListDto>> {
        if (requestParameters.userId === null || requestParameters.userId === undefined) {
            throw new runtime.RequiredError('userId','Required parameter requestParameters.userId was null or undefined when calling momoUserControllerPutCollections.');
        }

        if (requestParameters.userCollectionListDto === null || requestParameters.userCollectionListDto === undefined) {
            throw new runtime.RequiredError('userCollectionListDto','Required parameter requestParameters.userCollectionListDto was null or undefined when calling momoUserControllerPutCollections.');
        }
    ...
    /**
     */
    async momoUserControllerPutCollections(requestParameters: MomoUserControllerPutCollectionsRequest): Promise<UserCollectionListDto> {
    ...
    /**
     */
    async momoUserControllerSaveUserFriendRequestRaw(requestParameters: MomoUserControllerSaveUserFriendRequestRequest): Promise<runtime.ApiResponse<FriendUserDto>> {
        if (requestParameters.userId === null || requestParameters.userId === undefined) {
            throw new runtime.RequiredError('userId','Required parameter requestParameters.userId was null or undefined when calling momoUserControllerSaveUserFriendRequest.');
        }

        if (requestParameters.userFriendRequestDto === null || requestParameters.userFriendRequestDto === undefined) {
            throw new runtime.RequiredError('userFriendRequestDto','Required parameter requestParameters.userFriendRequestDto was null or undefined when calling momoUserControllerSaveUserFriendRequest.');
        }
    ...
    /**
     */
    async momoUserControllerSaveUserFriendRequest(requestParameters: MomoUserControllerSaveUserFriendRequestRequest): Promise<FriendUserDto> {
